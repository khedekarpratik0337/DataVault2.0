...
-- Creating Hubs for Customers and Orders

-- ldrs (Load Time Stamp)
-- rsrc (Raw Data Source)
...
SELECT n_nationkey
     ...
     , n_name
     , n_comment
  FROM l00_stg.stage_nation;



-- Connecting The Source Data with Raw Data Vault

CREATE OR REPLACE TASK customer_strm_tsk
  WAREHOUSE = Datavault_wh
  SCHEDULE = '1 minute'
WHEN
